...
The Packages panel installs a package you can already name. To *find* one, open the **🧩
Extensions** gallery (⌘K → "Extensions", or ☰ → Extensions): a browsable catalog of Slate
