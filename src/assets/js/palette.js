...
function paletteCommands() {
  ...
  const cmds = [
    ...
    { label: 'Export HTML', tag: 'export', run: exportHtml },
    { label: 'Export PDF (publication)', tag: 'export', run: exportPdf },
    { label: 'Export PDF (slides)', tag: 'export', run: () => exportSlidesPdf() },
    { label: 'Print notebook (HTML)', tag: 'export', run: printNotebook },
    { label: 'Export self-contained .jl', tag: 'export', run: exportStandalone },
