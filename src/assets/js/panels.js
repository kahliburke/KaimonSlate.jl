...
function connectLive() {
  ...
  es.onmessage = async (e) => {
    ...
    if (e.data.startsWith('specialist:')) { try { window.onSpecialistPush && window.onSpecialistPush(JSON.parse(e.data.slice(11))); } catch (_) {} return; }   // any specialist: asked, arrived, signed off (carries `role`)
