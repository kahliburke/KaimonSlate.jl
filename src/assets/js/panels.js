...
function connectLive() {
  ...
  es.onmessage = async (e) => {
    ...
    if (e.data.startsWith('sshauth-result:')) { try { window.onSshAuthResult && window.onSshAuthResult(JSON.parse(e.data.slice(15))); } catch (_) {} return; }   // …and here is whether it worked
