...
const UNDOCUMENTED_BY_DESIGN = Dict(
    ...
    "SweepTarget" => "abstract supertype of `ClusterTarget`/`LocalTarget`, documented with them",
    "SlurmTarget" => "`ClusterTarget` with the scheduler chosen — documented in its entry",
    "PbsTarget"   => "ditto",
