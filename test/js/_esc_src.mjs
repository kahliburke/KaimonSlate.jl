// Shared loader for the front end's one HTML escaper, `window.slateEscHtml` in esc.js.
//
...
const CORE = join(here, '..', '..', 'src', 'assets', 'js', 'esc.js');
...
export function loadEscHtml() {
  ...
  if (!m) { console.error('_esc_src: window.slateEscHtml is gone from esc.js'); process.exit(2); }
